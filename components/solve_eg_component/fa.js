...
export default function SolveFAQSection() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "To ensure project authenticity, every entry is required to nominate an academic teacher, tutor, or school coordinator. During registration, you will submit their official school email. We will contact them to validate your student status and authenticate your submission as a genuine school representative.",
    },
    {
      question: "What is the unified Innovation Track and what industries can I choose?",
      answer: "Rather than isolating students into social or tech silos, we run a unified Innovation Track. You can design social frameworks or tech-driven systems targeting one of five easy-to-understand industries: Education, Finance, DeepTech, HealthTech, or ClimateTech.",
    },
    {
      question: "Are there registration fees, and how will my submission be evaluated?",
      answer: "No, entering SOLVE is completely free from Day One. Your team's submission will be reviewed online by an expert panel of judges using our triple-alliteration evaluation standard: Innovation, Impact, and Implementation.",
    },
  ];
  ...
  return (
    <section style={styles.section}>
      ...
      <div style={{
        position: "absolute", top: "10%", right: "-20%", width: "400px", height: "400px",
        background: "radial-gradient(circle, rgba(34,211,238,0.03) 0%, transparent 70%)", pointerEvents: "none"
      }} />
      ...
      <div style={styles.container}>
        ...
        <div style={styles.headerBox}>
          ...
          <h2 style={styles.mainTitle}>Frequently Asked Questions</h2>
          <p style={styles.subtitle}>
            Have questions about templates, team formats, or requirements? Here is everything you need to know.
          </p>
        </div>
          ...
          {faqData.map((faq, index) => {
            ...
            return (
              <div 
                ...
                style={{
                  ...styles.accordionItem,
                  borderColor: isOpen ? "rgba(34, 211, 238, 0.2)" : "rgba(255, 255, 255, 0.03)"
                }}
              >
                {/* Accordion Trigger Header */}
                <button 
