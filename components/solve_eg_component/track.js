  ...
  return (
    <section style={styles.section}>
      ...
      <div style={styles.container}>
        ...
        {/* Section Heading */}
        <div style={styles.sectionHeader}>
          <span style={styles.sectionLabel}>The Blueprint</span>
          <h2 style={styles.sectionTitle}>One Track. Infinite Sectors.</h2>
          <p style={styles.sectionSubtitle}>
            Form a collaborative team of 2-5 peers (or fly solo if you are aged 13–18) and target any of our 5 high-impact industries.
          </p>
        </div>
        ...
        <div style={styles.splitGrid}>
          ...
          {/* COLUMN 1: UNIFIED TRACK & INDUSTRIES */}
          <div>
            <h3 style={styles.columnTitle}>
              <span style={{ width: "6px", height: "6px", borderRadius: "50%", backgroundColor: "#a855f7" }} />
              Innovation Track Focus
            </h3>

            {/* Unified Track: Innovation Card */}
            <motion.div
              custom={1}
              variants={cardFadeIn}
              initial="hidden"
            ...
            >
              <div style={styles.imageContainer}>
                <img 
                  src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop" 
                  alt="Unified Innovation Track"
                  className="solve-zoom-img"
                  style={styles.cardImage}
                />
                <div style={styles.imageOverlay} />
                <div style={{ ...styles.iconBadge, backgroundColor: "rgba(168, 85, 247, 0.15)", color: "#c084fc", border: "1px solid rgba(168, 85, 247, 0.3)" }}>
                  <Lightbulb size={18} />
                </div>
              </div>

              <div style={styles.cardContent}>
                <h4 style={styles.cardTitle}>Unified Innovation</h4>
                <p style={styles.cardDescription}>
                  Whether you construct direct hardware/tech designs or craft systemic, human-centered social frameworks—your main objective is simple: create positive global impact.
                </p>
                
                {/* 5 Curator Industries Choice */}
                <div style={styles.industryGrid}>
                  <div style={styles.industryItem}>
                    <GraduationCap size={16} color="#c084fc" />
                    <span>Education</span>
                  </div>
                  <div style={styles.industryItem}>
                    <Landmark size={16} color="#22d3ee" />
                    <span>Finance</span>
                  </div>
                  <div style={styles.industryItem}>
                  ...
                  <div style={styles.industryItem}>
                    <HeartPulse size={16} color="#22d3ee" />
                    <span>HealthTech</span>
                  </div>
                  <div style={{ ...styles.industryItem, gridColumn: "span 2", justifyContent: "center" }}>
                    <Leaf size={16} color="#4ade80" />
                    <span>ClimateTech Solutions</span>
                  </div>
                </div>
          ...
          {/* COLUMN 2: DELIVERABLES & 3 "I"s RUBRIC */}
          <div>
            <h3 style={styles.columnTitle}>
              <span style={{ width: "6px", height: "6px", borderRadius: "50%", backgroundColor: "#22d3ee" }} />
            ...
            {/* Deliverable 1: 10-Page Pitch Deck */}
            <motion.div
              custom={2}
              variants={cardFadeIn}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-100px" }}
              style={{ ...styles.trackCard, backgroundColor: "rgba(15, 15, 22, 0.45)", marginBottom: "20px" }}
            >
              <div style={{ padding: "28px" }}>
                <div style={{ display: "flex", gap: "16px", alignItems: "center", marginBottom: "16px" }}>
                  <div style={{ padding: "12px", backgroundColor: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "14px", color: "#ffffff" }}>
                    <Layers size={20} />
                  </div>
                  <div>
                    <h4 style={{ ...styles.cardTitle, fontSize: "18px", margin: 0 }}>1. 10-Page Pitch Deck</h4>
                    <span style={{ fontSize: "11px", color: "#71717a", fontWeight: 600 }}>Strict 10 Slide Limit</span>
                  </div>
                </div>

                <div style={{ borderTop: "1px solid rgba(255,255,255,0.04)", paddingTop: "8px" }}>
                  <p style={{ ...styles.cardDescription, fontSize: "13.5px" }}>
                    An explicit slide roadmap detailing the Problem, your Proposed Solution, market implementation feasibility, and scalability.
                  </p>
                </div>
              </div>
            </motion.div>

            {/* Deliverable 2: 1-Min Video Pitch */}
            <motion.div
              custom={3}
              variants={cardFadeIn}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-100px" }}
              style={{ ...styles.trackCard, backgroundColor: "rgba(15, 15, 22, 0.45)", marginBottom: "32px" }}
            >
              <div style={{ padding: "28px" }}>
                <div style={{ display: "flex", gap: "16px", alignItems: "center", marginBottom: "16px" }}>
                  <div style={{ padding: "12px", backgroundColor: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "14px", color: "#ffffff" }}>
                  ...
                  <div>
                    <h4 style={{ ...styles.cardTitle, fontSize: "18px", margin: 0 }}>2. 1-Minute Pitch Video</h4>
                    <span style={{ fontSize: "11px", color: "#22d3ee", fontWeight: 600 }}>Strict 60 Seconds Limit</span>
                  </div>
                </div>

                <div style={{ borderTop: "1px solid rgba(255,255,255,0.04)", paddingTop: "8px" }}>
                  <p style={{ ...styles.cardDescription, fontSize: "13.5px" }}>
                    A fast-paced, engaging elevator pitch to hook the judges, explain your concept, and state your team&#39;s vision.
                  </p>
                </div>
              </div>
            </motion.div>

            {/* Score Metric Alliteration Box */}
            <h3 style={{ ...styles.columnTitle, marginBottom: "20px" }}>
              <span style={{ width: "6px", height: "6px", borderRadius: "50%", backgroundColor: "#a855f7" }} />
              The Three &ldquo;I&rdquo; Evaluation Metrics
            </h3>
            ...
            <div style={styles.rubricContainer}>
              <div style={styles.rubricCard}>
                ...
                <p style={{ ...styles.cardDescription, fontSize: "13px" }}>
                  Originality and depth of design. Does the concept push current boundaries or provide a completely new outlook on resolving the target issue?
                </p>
              </div>
              ...
              <div style={styles.rubricCard}>
                ...
                <p style={{ ...styles.cardDescription, fontSize: "13px" }}>
                  The depth and quality of change. How effectively does the plan address the selected industry gap with realistic and measurable criteria?
                </p>
              </div>

              <div style={styles.rubricCard}>
                <div style={styles.rubricHeader}>
                  <Workflow size={16} color="#c084fc" />
                  <span>Implementation</span>
                </div>
                <p style={{ ...styles.cardDescription, fontSize: "13px" }}>
                  Feasibility of deployment. Is the project financially sustainable, realistic to implement, and built upon sound operational research?
                </p>
              </div>
            </div>
