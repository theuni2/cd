...
import React from "react";
import { motion } from "framer-motion";
import { Calendar, Hourglass, Cpu, Trophy } from "lucide-react";

export default function SolveTimelineSection() {
  // Ordered milestone data reflecting direct deadline tracking starting in August
  const milestones = [
    {
      step: "01",
      date: "Open",
    ...
    {
      step: "02",
      date: "15 October 2026 (Final Deadline)",
      title: "Comprehensive Dossier Submission",
      description: "The singular hard cutoff. Final 10-page Pitch Deck (PPT/PDF) and 1-minute video pitch must be finalized and submitted simultaneously with teacher credentials.",
      icon: <Hourglass size={18} />,
      accent: "#3b82f6", // Electric Blue
    },
    {
      ...
      title: "Triple-'I' Evaluation Review",
      description: "An expert panel of judges rigorously evaluates all submitted project dossiers against the core operational metrics: Innovation, Impact, and Implementation.",
      icon: <Cpu size={18} />,
      accent: "#22d3ee", // Vivid Cyan
    },
    {
      ...
      title: "Global Finale & Prize Awards",
      description: "The global ecosystem converges for the online virtual showcase.",
      icon: <Trophy size={18} />,
      accent: "#f59e0b", // Warm Gold
    },
  ];
    ...
    <section style={styles.section}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.headerBox}>
          ...
          <h2 style={styles.mainTitle}>The Journey to Impact</h2>
          <p style={styles.subtitle}>
            A streamlined timeline moving directly from August kickoff to the final milestone deadline with zero intermediate steps.
          </p>
        </div>
