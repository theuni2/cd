...
import React from "react";
import { motion } from "framer-motion";
import { Trophy, Award, Medal, ShieldCheck, FileText, Users, Mail, Compass, ArrowUpRight } from "lucide-react";
...
export default function SolveAwardsSection() {
  ...
  const prizeTiers = [
    {
      ...
      subHeading: "$750 Estimated Value",
      icon: <Award size={24} color="#c084fc" />,
      perks: [
        {
          title: "Personalised Profile Roadmap",
          detail: "1-on-1 strategic roadmap designed with an Education Strategist to elevate your global academic profile.",
          perkIcon: <Compass size={16} />,
        },
        {
          title: "Exclusive Merchandise",
          detail: "Custom competition-branded winner gear and physical merchandise package delivered directly to you.",
          perkIcon: <Medal size={16} />,
        },
        {
          title: "Certificate of Excellence",
          detail: "An official, verified credential recognizing your high-tier achievement in the global writing competition.",
          perkIcon: <ShieldCheck size={16} />,
        },
      ],
      ctaText: "View Distinction Perks",
    },
    {
      ...
      subHeading: "$1000 Estimated Value",
      icon: <Trophy size={28} color="#fbbf24" />,
      isFeatured: true,
      perks: [
        {
          title: "Personalised Founder Roadmap",
          detail: "Elite 1-on-1 global academic profile architecture designed directly with an agency Founder.",
          perkIcon: <Compass size={16} />,
        },
        {
          title: "Signed Letter of Commendation",
          detail: "An official executive recommendation letter detailing your unique research and writing excellence.",
          perkIcon: <Mail size={16} />,
        },
        {
          title: "Media Coverage & Showcase",
          detail: "Dedicated press features and public editorial coverage spotlighting your winning entry.",
          perkIcon: <FileText size={16} />,
        },
        {
          title: "Championship Trophy & Gear",
          detail: "A premium physical championship trophy alongside custom, exclusive winner merchandise.",
          perkIcon: <Trophy size={16} />,
        },
      ],
      ctaText: "Claim Your Fellowship",
    },
    {
      badge: "Third Prize",
      badgeColor: "rgba(34, 211, 238, 0.15)",
      ...
      subHeading: "$500 Estimated Value",
      icon: <Users size={24} color="#22d3ee" />,
      perks: [
        {
          title: "Personalised Profile Roadmap",
          detail: "1-on-1 strategic roadmap designed with an Education Strategist to maximize college profile trajectory.",
          perkIcon: <Compass size={16} />,
        },
        {
          title: "Official Winner Certificate",
          detail: "A formal, high-impact credential of achievement to anchor your college applications and resumes.",
          perkIcon: <ShieldCheck size={16} />,
        },
      ],
      ctaText: "Review Honors Criteria",
    },
  ];
  ...
  return (
    <section style={styles.section}>
      ...
      <div style={styles.container}>
        <div style={styles.headerBox}>
          <span style={styles.labelTag}>Distinction & Rewards</span>
          <h2 style={styles.mainTitle}>Recognition of Excellence</h2>
          <p style={styles.subtitle}>
            Accelerate your academic journey with global credentials, prestige positioning, and bespoke global profile engineering.
          </p>
        </div>
