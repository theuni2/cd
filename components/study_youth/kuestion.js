    ...
    >
      <div className="container mx-auto max-w-3xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Frequently Asked <br />
            <span style={{ color: '#fbbf24' }}>Questions.</span>
          </motion.h2>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div 
              ...
              style={{ 
                backgroundColor: openIndex === index ? 'rgba(30, 58, 138, 0.4)' : 'transparent',
                borderColor: openIndex === index ? '#fbbf24' : 'rgba(255,255,255,0.1)'
              }}
            >
              {/* Question Header */}
              <button
              ...
              >
                <span 
                  ...
                  style={{ color: openIndex === index ? '#fcd34d' : 'white' }}
                >
                  {faq.question}
                </span>
                ...
                <div 
                  ...
                  style={{ 
                    backgroundColor: openIndex === index ? '#fbbf24' : 'rgba(255,255,255,0.1)',
                    color: openIndex === index ? '#172554' : 'white'
                  }}
                >
