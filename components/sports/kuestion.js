...
const SportsFAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Instructors are typically industry experts with real-world experience building sports and impact projects. They bring professional credibility, which adds significant value when they mentor you and certify your work."
    },
    {
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div 
              ...
              style={{ 
                backgroundColor: openIndex === index ? 'rgba(30, 41, 59, 0.5)' : 'transparent',
                borderColor: openIndex === index ? '#f97316' : 'rgba(255,255,255,0.1)'
              }}
            >
              {/* Question Header */}
              <button
              ...
              >
                <span 
                  ...
                  style={{ color: openIndex === index ? '#fdba74' : 'white' }}
                >
                  {faq.question}
                </span>
                ...
                <div 
                  ...
                  style={{ 
                    backgroundColor: openIndex === index ? '#f97316' : 'rgba(255,255,255,0.1)',
                    color: openIndex === index ? '#fff' : 'white'
                  }}
                >
