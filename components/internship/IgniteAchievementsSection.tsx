...
const achievements = [
  {
    ...
    description:
      "Our 12th grader did shadow internship with the global consulting firm Protiviti, building corporate sustainability frameworks and analyzing ESG compliance strategies.",
    image: "https://protiviticareer.com/wp-content/uploads/2022/04/Protiviti-Logo-Blue.png", // Upload and replace with actual path
  },
  {
    title: "Political Science Research Internship",
    description:
