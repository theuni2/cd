...
//         /* INLINE PARTNER BLOCK ADJUSTMENT */
//         .partner-block {
//           display: flex;
//           flex-direction: row; /* Aligns text and logo in a horizontal row */
//           align-items: center;  /* Vertically centers text and image */
//           gap: 16px;            /* Space between label and logo */
//         }
...
//           color: #718096;
//           font-weight: 600;
//           white-space: nowrap; /* Prevents awkward line wraps on desktop */
//         }
...
//           }
//           .partner-block {
//             flex-direction: column; /* Stack gracefully on small mobile screens */
...
//                 {/* Education Partner Block (In-Line Label & Logo) */}
//                 <div className="partner-block">
//                   <span className="partner-label">Education Partner Uni Discovery</span>
//                   <div className="partner-logo-box">
//                     <img 
          ...
          <div className="footer-content">
            ...
            <div className="brand-col">
              ...
              <div className="partners-container">
                ...
                {/* Media Partner Block */}
                <div className="partner-block">
                  <span className="partner-label">Media Partner, Khalej Times</span>
                  <div className="partner-logo-box">
                    <img 
                      src="/KT.jpg" 
                      alt="Media Partner" 
