    ...
    <>
      ...
      <section className="rules-section">
        <div className="container">
          ...
          <div className="section-header">
            <h2 className="section-title">Rules & Eligibility</h2>
            <p className="section-desc">Strict adherence to academic standards is required to ensure a fair competition.</p>
          </div>
          ...
          <div className="rules-grid">
            ...
            <div className="rule-card">
              ...
              <div className="rule-content">
                <h3>Format & Length</h3>
                <p>
                  Essays must be submitted as a PDF. The word count must not exceed <strong>2,000 words</strong>. This excludes bibliography and authorship declarations.
                </p>
              </div>
            </div>
            ...
            <div className="rule-card">
              ...
              <div className="rule-content">
                <h3>Blind Grading</h3>
                <p>
                  To ensure impartiality, <strong>do not include your name</strong> on the essay PDF. Your details are linked via your registration number only.
                </p>
              </div>
            </div>

            {/* RULE 5: ANNOUNCEMENT (FIXED) */}
            {/* <div className="rule-card">
              <div className="icon-box">
                <BellRing size={20} />
              </div>
          ...
          <div className="note-box">
            <p className="note-text">
              Registration closes on <strong> <span className="highlight-text">31st May 2026</span></strong>. Late entries will be accepted until 10 July.<br/>
              {/* <span className="note-link">Read Fullp Terms & Conditions</span> */}
