...
import { useState } from 'react';
import { motion } from 'framer-motion';
import { Play, Sparkles, CheckCircle, Tag, FlaskConical, Orbit, Cpu, Leaf, Award } from 'lucide-react';
...
export default function JudgesAndExemplars() {
  ...
  // Exemplar Entry Benchmarks Across Tracks
  const exemplars = [
    {
      title: 'Visualizing Transformer Neural Architectures',
      topic: 'CS & AI',
      duration: '1:58',
      author: 'Exemplar Showcase 01',
      thumbnail: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=600&q=80',
      description: 'Demystifying self-attention mechanisms in artificial intelligence using geometric node animations.',
    },
    {
      title: 'Catalytic Decomposition & Enzyme Kinetics',
      topic: 'Chemistry',
      duration: '1:52',
      author: 'Exemplar Showcase 02',
      thumbnail: 'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?auto=format&fit=crop&w=600&q=80',
      description: 'Using high-speed macromolecular models to explain activation energy shifts in real-time.',
    },
  ];
  ...
  return (
    <section style={styles.wrapper}>
      ...
      {/* ---------------- SECTION 1: DOMAIN-SPECIFIC JUDGING PANEL ---------------- */}
      <div style={styles.container}>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          style={styles.headerBlock}
        >
          <span style={styles.sectionLabel}>Academic Rigor</span>
          <h2 style={styles.sectionTitle}>Evaluated by Research PhDs</h2>
          <p style={styles.sectionDesc}>
            Your submission is reviewed by specialist researchers and doctoral faculty assigned specifically to your chosen subject track.
          </p>
        </motion.div>
        ...
        <div style={styles.grid3}>
          {judges.map((judge, idx) => (
            ...
            >
              ...
              <h3 style={styles.judgeName}>{judge.name}</h3>
              {/* <p style={styles.judgeTrack}>{judge.track}</p> */}
              <p style={styles.judgeRole}>{judge.role}</p>
              <p style={styles.judgeInst}>{judge.institution}</p>÷
            </motion.div>
          ))}
      ...
      <div style={styles.container}>
        {/* <motion.div
          ...
          style={styles.headerBlock}
        >
          <span style={styles.sectionLabelCyan}>Inspiration & Benchmarks</span>
          <h2 style={styles.sectionTitle}>What a Winning Entry Looks Like</h2>
          <p style={styles.sectionDesc}>
...
{/* 
        ...
        >
          <div style={styles.criteriaHeaderRow}>
            ...
            <h4 style={styles.criteriaTitle}>Official Evaluation Rubric</h4>
          </div>

          <div style={styles.criteriaGrid}>
            <div style={styles.criteriaItem}>
              <CheckCircle size={18} color="#06B6D4" />
              <span><strong>Scientific Rigor (30%):</strong> Accurately explains complex research principles</span>
            </div>
            <div style={styles.criteriaItem}>
              <CheckCircle size={18} color="#06B6D4" />
              <span><strong>Analytical Clarity (30%):</strong> Simplifies ideas without losing depth</span>
            </div>
            <div style={styles.criteriaItem}>
              <CheckCircle size={18} color="#06B6D4" />
              <span><strong>Visual Storytelling (20%):</strong> Creative models, diagrams, or animations</span>
            </div>
            <div style={styles.criteriaItem}>
              <CheckCircle size={18} color="#06B6D4" />
              <span><strong>Real-World Relevance (20%):</strong> Connects the inquiry to global challenges</span>
            </div>
          </div>

          {/* Hashtag Reminder Strip */}
          {/* <div style={styles.hashtagStrip}>
