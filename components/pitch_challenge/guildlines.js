...
const guidelines = [
  ...
  icon: <Video size={24} color="#6366F1" />,
  title: "Format & Hosting",
  desc: "Upload to YouTube. Use the title format \"[Video Title] | Discovery Challenge by Career Discovery\" and include #discoverychallenge and #careerdiscovery in your description."
},
  {
