  ...
  return (
    <section style={styles.section}>
      ...
      <div style={styles.container}>
        ...
        >
          Explain a Big Idea. <br />
          <span style={styles.gradientText}>Enter the Discovery Challenge.</span>
        </motion.h1>
        ...
        >
          <div style={styles.statItem}>
            <Trophy size={24} color="#F59E0B" />
            <div>
              <p style={styles.statTitle}>Discovery Challenge</p>
              <p style={styles.statSub}>Global Student Competition</p>
            </div>
          </div>
