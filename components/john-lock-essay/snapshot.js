...
import React from 'react';
import { motion } from 'framer-motion';
import { ListOrdered, Target, Trophy, Check, Calendar, MessageSquare, Clock } from 'lucide-react';
  ...
  return (
    <section className="py-24 relative overflow-hidden" style={{ backgroundColor: '#0f172a' }}>
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        {/* --- BOTTOM SECTION: LOGISTICS & COMMITMENT --- */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ delay: 0.2 }}
          className="mt-16 pt-12 border-t border-slate-800 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left"
        >
          <div className="flex flex-col md:flex-row items-center gap-4 p-4 rounded-xl bg-slate-900/30 border border-slate-800/60">
            <div className="p-3 rounded-xl bg-blue-500/10 text-blue-400 shrink-0">
              <Calendar size={24} />
            </div>
            <div>
              <h4 className="text-white font-semibold text-base">Weekly 1-on-1 Mentorship</h4>
              <p className="text-slate-400 text-sm mt-0.5">Live strategy calls once a week for 8 weeks.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 p-4 rounded-xl bg-slate-900/30 border border-slate-800/60">
            ...
            <div>
              <h4 className="text-white font-semibold text-base">24/7 Dedicated Support</h4>
              <p className="text-slate-400 text-sm mt-0.5">Continuous WhatsApp access for questions and guidance.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 p-4 rounded-xl bg-slate-900/30 border border-slate-800/60">
            ...
            <div>
              <h4 className="text-white font-semibold text-base">Weekly Time Commitment</h4>
              <p className="text-slate-400 text-sm mt-0.5">3–4 hours of structured assignments and readings.</p>
            </div>
          </div>
        </motion.div>
