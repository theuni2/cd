    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <form className="max-w-lg mx-auto">
          ...
          <button type="submit" className="w-full bg-blue-500 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300">Send Message</button>
        </form>
      </div>
    </section>
  )
